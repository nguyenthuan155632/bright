...
class DictionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post dictionaries_url, params: { dictionary: { category_id: @dictionary.category_id, description: @dictionary.description, english: @dictionary.english, learning_count: @dictionary.learning_count, learning_speed: @dictionary.learning_speed, vietnamese: @dictionary.vietnamese, vietnamese_unsigned: @dictionary.vietnamese_unsigned } }
    end
  ...
  test "should update dictionary" do
    patch dictionary_url(@dictionary), params: { dictionary: { category_id: @dictionary.category_id, description: @dictionary.description, english: @dictionary.english, learning_count: @dictionary.learning_count, learning_speed: @dictionary.learning_speed, vietnamese: @dictionary.vietnamese, vietnamese_unsigned: @dictionary.vietnamese_unsigned } }
