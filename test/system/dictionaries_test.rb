...
class DictionariesTest < ApplicationSystemTestCase
  ...
  test "creating a Dictionary" do
    ...
    fill_in "Category", with: @dictionary.category_id
    fill_in "Description", with: @dictionary.description
    fill_in "English", with: @dictionary.english
    fill_in "Learning Count", with: @dictionary.learning_count
    fill_in "Learning Speed", with: @dictionary.learning_speed
    fill_in "Vietnamese", with: @dictionary.vietnamese
    fill_in "Vietnamese Unsigned", with: @dictionary.vietnamese_unsigned
